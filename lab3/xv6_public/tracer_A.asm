...
00000000 <main>:
  ...
  31:	6a 14                	push   $0x14
  33:	e8 4b 03 00 00       	call   383 <sleep>
  38:	e8 66 03 00 00       	call   3a3 <get_parent_pid>
  3d:	89 c3                	mov    %eax,%ebx
  3f:	e8 2f 03 00 00       	call   373 <getpid>
  44:	53                   	push   %ebx
  45:	50                   	push   %eax
  46:	68 bc 07 00 00       	push   $0x7bc
  4b:	6a 01                	push   $0x1
  4d:	e8 2e 04 00 00       	call   480 <printf>
  52:	83 c4 14             	add    $0x14,%esp
  55:	68 e8 03 00 00       	push   $0x3e8
  5a:	e8 24 03 00 00       	call   383 <sleep>
  5f:	e8 3f 03 00 00       	call   3a3 <get_parent_pid>
  64:	89 c3                	mov    %eax,%ebx
  66:	e8 08 03 00 00       	call   373 <getpid>
  6b:	53                   	push   %ebx
  6c:	50                   	push   %eax
  6d:	68 bc 07 00 00       	push   $0x7bc
  72:	6a 01                	push   $0x1
  ...
  7e:	50                   	push   %eax
  7f:	50                   	push   %eax
  80:	68 a8 07 00 00       	push   $0x7a8
  85:	6a 01                	push   $0x1
  87:	e8 f4 03 00 00       	call   480 <printf>
  8c:	e8 62 02 00 00       	call   2f3 <exit>
  91:	66 90                	xchg   %ax,%ax
  93:	66 90                	xchg   %ax,%ax
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
 ...
 621:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 792:	00 00 00 
    if(p->s.size >= nunits){
