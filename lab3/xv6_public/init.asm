...
00000000 <main>:
  ...
  ab:	68 53 08 00 00       	push   $0x853
  b0:	e8 d6 02 00 00       	call   38b <exec>
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 56 08 00 00       	push   $0x856
  bc:	6a 01                	push   $0x1
...
00000420 <printint>:
 ...
 459:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
...
000004d0 <printf>:
 ...
 656:	bb b1 08 00 00       	mov    $0x8b1,%ebx
...
000006a0 <free>:
 ...
 6a4:	55                   	push   %ebp
 6a5:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 ...
 6f1:	5b                   	pop    %ebx
 6f2:	a3 6c 0b 00 00       	mov    %eax,0xb6c
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 6fa:	c3                   	ret    
 ...
 71a:	a3 6c 0b 00 00       	mov    %eax,0xb6c
...
00000730 <malloc>:
 ...
 740:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
 ...
 789:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
 ...
 7b7:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 ...
 7e7:	a3 6c 0b 00 00       	mov    %eax,0xb6c
 ...
 800:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 807:	0b 00 00 
 80a:	bf 70 0b 00 00       	mov    $0xb70,%edi
 80f:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 816:	0b 00 00 
 819:	89 f8                	mov    %edi,%eax
 81b:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 822:	00 00 00 
