...
int main(int argc, char *argv[])
{
  ...
  23:	c7 04 24 c8 08 00 00 	movl   $0x8c8,(%esp)
    int a = atoi(argv[1]);
...
void convert_to_string(int value, char* result, int base) {
  ...
  eb:	8b 1d 44 0c 00 00    	mov    0xc44,%ebx
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb 28 09 00 00       	mov    $0x928,%ebx
        while(*s != 0){
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 48 0c 00 00       	mov    %eax,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 48 0c 00 00       	mov    0xc48,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 48 0c 00 00 4c 	movl   $0xc4c,0xc48
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 4c 0c 00 00       	mov    $0xc4c,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 4c 0c 00 00 4c 	movl   $0xc4c,0xc4c
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 8b2:	00 00 00 
    if(p->s.size >= nunits){
