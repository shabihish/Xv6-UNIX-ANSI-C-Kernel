...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb c1 08 00 00       	mov    $0x8c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b5:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 6d6:	73 10                	jae    6e8 <free+0x38>
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 707:	5e                   	pop    %esi
 708:	5f                   	pop    %edi
 709:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 74d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 750:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	a1 7c 0b 00 00       	mov    0xb7c,%eax
 ...
 7f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7f7:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 ...
 80e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 7c 0b 00 00 80 	movl   $0xb80,0xb7c
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf 80 0b 00 00       	mov    $0xb80,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 826:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
